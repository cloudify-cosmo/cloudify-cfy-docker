FROM alpine:3.12.0
RUN echo -e "http://nl.alpinelinux.org/alpine/v3.12/community\nhttp://nl.alpinelinux.org/alpine/v3.12/main" > /etc/apk/repositories
RUN apk update && apk install docker
